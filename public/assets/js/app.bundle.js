                ...
                : (o.addClass(n.initClass),
                  ...
                  o.find("li a").on("mousedown", function (e) {
                      0 !== i(this).parent().find("ul").length &&
                          ...
                          i(this).parent().find("ul:first").is(":visible") &&
                          !i(this).parent().find("ul:first").hasClass("active")
                              ? i(this)
                                    .parent()
                                    .find("ul:first")
                                    .slideUp(
        ...
        (p.fn[f] = function (e) {
            if ("string" == typeof e) {
                ...
                return (
                    this.each(function () {
                        if (
                            !p.data(this, "plugin_" + f) ||
                            "function" != typeof p.data(this, "plugin_" + f)[t]
                        )
                            throw new Error(
                                "Method " + t + " does not exist on jQuery." + f
                            );
            ...
            if ("object" == typeof e || !e)
                return this.each(function () {
                    p.data(this, "plugin_" + f) ||
                        p.data(this, "plugin_" + f, new i(this, e));
                });
        }),
            (p.fn[f].defaults = {
                onInit: function () {},
...
var initApp = (function (e) {
        return (
            (e.listFilter = function (t, e, o) {
                o
                    ? $(o).addClass("js-list-filter")
                    : $(t).addClass("js-list-filter"),
                    $(e)
                        .change(function () {
            ...
            (e.removeSettings = function (e) {
                ...
                null != e
                    ...
                    : console.log(
                          "ERROR: You must specify the class you need to remove"
                      );
            }),
                        ...
                        void 0 !== $.fn.slimScroll
                            ? (myapp_config.navAnchor.slimScroll({
                              ...
                              document.getElementById(
                                  ...
                                  myapp_config.debugState &&
                                      console.log(
                                          "----top controls destroyed"
                                      )),
                              myapp_config.debugState &&
                                  console.log("slimScroll created"))
                            : console.log("$.fn.slimScroll...NOT FOUND");
                        break;
                    case myapp_config.navAnchor
                        .parent()
                ...
                $(".custom-file input").change(function (e) {
                    ...
                    "desktop" === myapp_config.thisDevice
                        ? ($(
                              ...
                              position:
                                  $(this).data("scrollPosition") || "right",
                              color:
                                  $(this).data("scrollColor") ||
                                  "rgba(0,0,0,0.6)",
                              alwaysVisible:
                                  $(this).data("scrollAlwaysVisible") || !1,
                              distance: $(this).data("scrollDistance") || "4px",
                              railVisible:
                                  $(this).data("scrollRailVisible") || !1,
                              railColor:
                                  $(this).data("scrollRailColor") || "#fafafa",
                              allowPageScroll: !1,
                              disableFadeOut: !1,
                          }),
                          myapp_config.debugState &&
                              console.log(
                                  "%c✔ SlimScroll plugin active",
                                  "color: #148f32"
                              ))
                        : (console.log(
                    ...
                    window.Waves && myapp_config.rippleEffect
                        ? (Waves.attach(
                          ...
                          myapp_config.debugState &&
                              console.log(
                                  "%c✔ Waves plugin active",
                                  "color: #148f32"
                              ))
                        : myapp_config.debugState &&
                          console.log(
                              "%c✘ Waves plugin inactive! ",
                              "color: #fd3995"
                          ),
                        ...
                        function (e) {
                            ...
                            switch (!0) {
                                ...
                                case "panel-fullscreen" === o:
                                    (r = $(this).closest(".panel")).toggleClass(
                                        "panel-fullscreen"
                                    ),
                                        myapp_config.root_.toggleClass(
                                            "panel-fullscreen"
                                        ),
                                        myapp_config.debugState &&
                                            console.log(
    ...
    layouts = (function (e) {
        return (
            (e.errorMessage = function (e) {
                console.log(
                    "('" + e + "') is not a valid entry, enter 'on' or 'off'"
                );
            }),
