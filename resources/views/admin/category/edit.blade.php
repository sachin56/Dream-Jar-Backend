            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action="{{ route('category.update',$category->id) }}" enctype="multipart/form-data" method="post" id="user-form" class="smart-form row" autocomplete="off" data-parsley-validate>
                            @csrf
                            @method('put')
                            ...
                            <div class="mb-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" name="name" maxlength="51" class="form-control" @if(isset($category->name)) value="{{$category->name}}" @endif required>
