...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chart-area'></i> Create ICON <span class='fw-300'></span>
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Create <span class="fw-300"><i>ICON</i></span>
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action="{{ route('icon.store') }}" enctype="multipart/form-data" method="post" id="user-form" class="smart-form row" autocomplete="off" data-parsley-validate>
                            @csrf

                            <div class="mb-3 col-12">
                                <div class="form-group">
                                    <label class="form-label" for="name">ICON Name</label>
                                    <input type="text" id="icon"  name="icon" class="form-control" value="{{ old('icon') }}" required>
                                    <span id="name-error" class="text-danger" style="display: none;" required></span>
                                    <div class="invalid-feedback">ICON Name is required, you missed this one.</div>
                                    @error('name')
